...
export async function prepare(page, context) {
  ...
  await page.addInitScript(({ sensors, mode }) => {
    ...
    globalThis.plugins = {
      Sensorsdataprovider: plugin,
      Linkprovider: { open(url) { globalThis.__openedMarketplaceUrl = url; } },
    };
    ...
    globalThis.__powerFixture = {
      ...
      totalSensor: {
        type: 'power', kind: 'total-power-draw', device: 'RMx SHIFT', name: 'Total Power Draw', units: 'W', value: '412', connected: true,
      },
    };
