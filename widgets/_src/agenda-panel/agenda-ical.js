...
async function calendarParserReady() {
  try {
    if (globalThis.__packratIcalReady && typeof globalThis.__packratIcalReady.then === "function") {
      await globalThis.__packratIcalReady;
    }
  } catch (error) {}
